...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Keyes Real Estate is a full-service Los Angeles brokerage led by broker-attorney Brad Keyes. Residential, commercial, and investment properties handled with legal precision." },
      { property: "og:title", content: "Keyes Real Estate — Pasadena to the Palisades™" },
      { property: "og:description", content: "Luxury LA real estate advisory. Residential · Commercial · Investment." },
